...
const tragamonedas: TragamonedasClasico = new TragamonedasClasico("Tragamonedas Clasico",10, " Se arroja la palanca si saca 🍒🍒🍒 Gana el juego. ");
const tragamonedasPlus: TragamonedasPlus = new Tragamonedas("Tragamonedas Plus",15, " Consigue tres 🍒 en cualquiera de las dos filas para ganar. ");
